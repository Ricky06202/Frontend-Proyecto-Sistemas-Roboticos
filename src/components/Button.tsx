...
export default function Button({ text, class: className }: Props) {
	return (
		<button
			className={'relative px-6 py-3 overflow-hidden font-bold text-white bg-blue-700 rounded-lg group ' + className}
		>
